...
<div class="mt-4">
    <div class="container-fluid position-relative"
        style="background: linear-gradient(rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0.5)), url('{{ asset('asset/food.jpg') }}') no-repeat center center / cover; height: 100vh; padding: 20px;">
        ...
        <form method="GET" action="{{ route('orders.index') }}" class="row position-relative" style="z-index: 1;">
            ...
            <div class="col-md-3">
                <input type="text" name="product" class="form-control" placeholder="Product Name" value="{{ request('product') }}">
            </div>
